...
data class TransactionRequest (val amount : String, val method : String, val type:String, val nonce : String, val test : String, val reference_transaction_id:String, val client_ip : String, val device_code : String, val device_id:String,
                               val market_code : String, val referrerUrl : String, val notes:String,  val emv : EMV_TransactionBody?, val card : CardRequest?, val action_code:String, val custom_fields : ArrayList<AdditionalDataFiles>?, val additional_data : ArrayList<AdditionalDataFiles>,val customer:CustomerRequest?) : Serializable
...
data class CustomerRequest(val firstName:String?,val lastName:String?,val street_1:String?,val street_2:String?,val city:String?,val state:String?,val zip:String?,val country:String?,
