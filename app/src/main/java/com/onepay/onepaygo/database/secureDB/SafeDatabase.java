...
class SafeDatabase implements SupportSQLiteDatabase {
   ...
   */
  @Override
  public void beginTransactionWithListener(final SQLiteTransactionListener listener) {
   ...
   */
  @Override
  public void beginTransactionWithListenerNonExclusive(final SQLiteTransactionListener listener) {
